...
const Statistics: React.FC = () => {
    ...
    return (
        <>
                ...
                <>
                    ...
                    <div className="statistics-box">
                        ...
                        <button className="button-stat" onClick={handleReservedBooksClick}>
                            <span
                                className="button-text-stat">Readers who reserved books:</span> {readersStatistics.readersWhoReservedBooks}
                        </button>
            ...
            {readersFromSearch.length > 0 && (<ListOfReaders sortOptions={sortOptionsReader} readers={readersFromSearch}
                                                             onReaderClick={fetchReaderInfo} title={"Readers"}/>)}
            </div>
        </>
    );
};
